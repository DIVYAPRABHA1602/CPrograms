...
Button sqrt = (Button) findViewById(R.id.button1);
...
Button cub = (Button) findViewById(R.id.button3);
cub.setOnClickListener(new OnClickListener() {
public void onClick(View v)
{ try
{
txtData1 = (EditText) findViewById(R.id.edittext1);
...
result3=num1/num2;
Toast.makeText(getBaseContext(),"ANSWER:"+result3,Toast.LENGTH_SHORT).show();
}
catch(Exception e)
{
Toast.makeText(getBaseContext(), e.getMessage(),
